...
import { faComment, faComments, faCalendar } from '@fortawesome/free-regular-svg-icons';
@NgModule({
  declarations: [
    AppComponent
  ],
...
export class AppModule {
  constructor() {
    library.add(faTimesCircle, faComment, faComments, faTasks, faCalendar, faUser, faAddressBook, faUserEdit);
  }
}
